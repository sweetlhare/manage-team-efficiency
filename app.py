...
if os.path.isfile('general/specialists.csv'):
    specialists = pd.read_csv('general/specialists.csv')
else:
    ...
    specialists.to_csv('general/specialists.csv')
    print('Please add specialists to specialists.csv')

# значение это уровень (0-отсутствие, 1-джун, 2-мидл, 3-сеньор)

if os.path.isfile('general/employees_interaction_matrix.csv'):
    print('general/employees_interaction_matrix already exists')
    employees_interaction_matrix = pd.read_csv('general/employees_interaction_matrix.csv').set_index('id')
else:
    ...
    employees_interaction_matrix.to_csv('general/employees_interaction_matrix.csv', index=False)
...
if start_project:
    ...
    psycho_test = pd.read_csv('general/psycho_test.csv')
